...
class StatusSuratKeterangan
{
    ...
    protected $linkTemplate = '<a href="%s" class="btn px-0 ml-2 p- text-sm" style="background-color : #EEC01D" target="%s">%s</a>';
    ...
    public function renderLink($status, $url_ajukan = null, $url_lihat_surat = null, $target = '_self')
    {
        ...
        } else if ($status == STATUS_MENUNGGU_VALIDASI || $status == STATUS_SELESAI_BEASISWA) {
            return '';
        }

...
<div class="p-4">
    <div class="rounded p-3" style="background-color: #f3f3f3;">
        <div>
            <h1>Edit Data Surat Keterangan Bebas UKT</h1>
        </div>
        <div class="">
            <?= validation_list_errors() ?>

            <?= form_open_multipart('keuangan/bebas-ukt/update/' . $sk_bebas_perpustakaan->id) ?>
            ...
            <div class="mb-3">
                <div class="form-group mb-3">
                    ...
                    <select class="form-control" name="status" id="status">
                        ...
                        <option value="<?= STATUS_SELESAI_BEASISWA ?>" <?= $sk_bebas_perpustakaan?->status == STATUS_SELESAI_BEASISWA ? 'selected' : '' ?>>Selesai Beasiswa</option>
                    </select>
                </div>

          ...
          <div class="col-12 mb-5">
            <div class="pengajuan py-4">
              ...
              <?php if ($sk_bebas_perpustakaan?->isSelesai()): ?>
                ...
                <div>
                  <?= view_cell('\App\Cells\StatusSuratKeterangan::renderLink', ['status' => $sk_bebas_perpustakaan->status ?? 'selesai', 'url' => route_to('file_surat_keterangan', $sk_bebas_perpustakaan->id ?? 4)]) ?>
                </div>

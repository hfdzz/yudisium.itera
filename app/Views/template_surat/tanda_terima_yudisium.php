...
<body>
    <div id="body">
        ...
        <div class="header">
            ...
            <div style="text-align: center;text-decoration:underline;font-weight:bold;margin-top:1rem">TANDA TERIMA PENDAFTARAN YUDISIUM</div>
        </div>
        <main>
            <br>
            <p style="text-align: justify;">Telah Terima Berkas Pendaftaran Yudisium Periode Juni 2024 :</p>
            <table>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
            ...
            <div style="float: right;">
                ...
                <br>
                <br>
                <div style="text-align: left;"><?= $peninjau->username ?></div> 
                <div style="text-align: left;margin-top:0.5rem">NIP. <?= $peninjau->nip ?></div>
            </div>
        </main>
    </div>
</body>

          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Periode Yudisium</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
            ...
            <?= form_open(route_to('fakultas.periode_yudisium'), ['class' => 'form']) ?>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <label for="tanggal_awal" class="form-label">Tanggal Yudisium</label>
                            <?= form_input('tanggal_yudisium', $latest_periode->tanggal_yudisium, ['class' => 'form-control', 'id' => 'tanggal_yudisium'], 'date') ?>
                        </div>
                        <div class="mb-3">
